...
class Atri:
	def __init__(self, state: Any):
		...
		self.navbarMain = state["navbarMain"]
	...
	@property
	def navbarMain(self):
		self._getter_access_tracker["navbarMain"] = {}
		return self._navbarMain
	@navbarMain.setter
	def navbarMain(self, new_state):
		self._setter_access_tracker["navbarMain"] = {}
		global default_state
		self._navbarMain = Flex(new_state, default_state["navbarMain"])
